  ...
  return (
    <div className="w-full bg-white pb-12">
      ...
      <section className="mx-auto max-w-7xl px-4 py-3 sm:px-6 sm:py-6 lg:px-8">
        <div className="aspect-[16/9] w-full overflow-hidden rounded-lg bg-gray-100 sm:rounded-xl">
          <img
        ...
        <div className="mt-2 grid grid-cols-3 gap-1.5 sm:mt-3 sm:grid-cols-4 sm:gap-2 md:grid-cols-6">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-6 lg:grid-cols-3 lg:gap-9">
          {/* Left column */}
          <div className="lg:col-span-2 space-y-5 sm:space-y-6">
            ...
            <div className="border-t border-gray-200 pt-5">
              <div className="text-xl font-bold text-emerald-700 sm:text-2xl">{property.price}</div>
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {detailItems.map((item) => (
                <div key={item.label} className="flex items-center gap-2.5 rounded-lg bg-gray-50 p-3">
            ...
            <div>
              ...
              <p className="mt-2 leading-6 text-gray-600">{property.description}</p>
            </div>

            {/* Amenities */}
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Amenities</h2>
              <div className="mt-2 grid grid-cols-2 gap-1.5 sm:mt-3 sm:gap-2 sm:grid-cols-3">
          ...
          <div className="space-y-5 sm:space-y-6">
            <div className="rounded-xl bg-gray-50 p-3.5 sm:p-5">
              ...
              <form onSubmit={(e) => e.preventDefault()} className="mt-3 space-y-3">
                ...
                <button
                  type="submit"
                  className="w-full rounded-full bg-black py-2 text-sm font-medium text-white hover:bg-gray-800"
                >
                  Send inquiry
                </button>
              </form>
            ...
            <div className="h-40 w-full rounded-lg bg-gray-200 sm:h-52 sm:rounded-xl">
